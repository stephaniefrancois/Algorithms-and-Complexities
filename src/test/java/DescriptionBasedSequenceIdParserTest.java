...
public class DescriptionBasedSequenceIdParserTest {
    ...
    public void GivenDescriptionWithMissingStartingPipeShouldThrow() {
        ...
        // when
        // then
        Exception thrown = assertThrows(SequenceIdNotFoundException.class, () -> {
    ...
    @Test
    public void GivenDescriptionWithIdentifierLongerThanSixCharactersShouldThrow() {
        // given
        FastaSequenceIdParser sut = new DescriptionBasedSequenceIdParser();
        String description = ">sp|Q5TYQ11|ZYG11_DANRE Protein zyg-11 homolog OS=Danio rerio GN=zyg11 PE=2 SV=1";
        ...
        assertThat(thrown.getMessage(), containsString("Q5TYQ11"));
    }
